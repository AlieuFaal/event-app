      ...
      >
        ...
        <View className="p-6 bg-white dark:bg-gray-900">
          ...
          <View className="bg-purple-100 dark:bg-purple-900/30 self-start px-3 py-1 rounded-full mb-4">
            <Text className="text-purple-700 dark:text-purple-400 font-medium">
              {data.genre}
            </Text>
          </View>
          ...
          <View className="flex-row gap-3 mt-4">
            {isInCalendar ? (
              <Button
                className="flex-1 p-4 border border-primary h-fit gap-2 dark:bg-card-foreground"
                onPress={handleRemoveFromCalendar}
              >
                <Check size={16} color="white" />
                <Text className="text-white dark:text-purple-400 font-semibold">
                  Added
                </Text>
              </Button>
            ) : (
