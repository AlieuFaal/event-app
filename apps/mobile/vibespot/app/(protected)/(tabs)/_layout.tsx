...
export default function TabsLayout() {
    return (
        <Tabs screenOptions={{ headerShown: false }} tabBar={({ state, navigation }) => (
            <View className='flex-row items-center justify-around bg-gray-50 p-2 rounded-full shadow-lg drop-shadow-xl w-screen mx-auto scale-90 mb-4'>
                    ...
                    if (route.name === 'create-event') {
                        return (
                            <Pressable
                                key={route.key}
                                onPress={onPress}
                                className='items-center bg-gray-100 p-4 rounded-full shadow-lg drop-shadow-xl scale-90 active:scale-125 transition-transform duration-200'
                            >
