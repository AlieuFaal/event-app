export const PlaceholderImage1 = require("./images/placeholder1.jpg");
export const PlaceholderImage2 = require("./images/placeholder2.jpg");
export const PlaceholderImage3 = require("./images/placeholder3.jpg");
