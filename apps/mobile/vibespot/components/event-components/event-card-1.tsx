        ...
        <Pressable className="active:scale-90 transition-transform duration-200"
            ...
            <Card className="bg-gray-100 dark:bg-gray-900 dark:border-0 w-80 items-center rounded-3xl mx-auto h-96 mt-2 shadow drop-shadow-lg border-primary">
                ...
                <CardContent className="w-full h-fit justify-center items-center -top-12">
                    <CardTitle className="text-xl mt-6 text-gray-900 dark:text-white">{event.title}</CardTitle>
                    <CardDescription className="text-lg line-clamp-1 text-gray-600 dark:text-gray-300">{event.description}</CardDescription>
                </CardContent>
            </Card>
        </Pressable>
    );
