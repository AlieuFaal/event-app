...
import { lazy, type ComponentProps, Suspense, useState } from "react";
		...
		<div className="flex flex-col max-w-7xl mx-auto my-4 md:my-8 lg:my-10 px-4">
			<Card className="p-4 md:p-8 lg:p-10 bg-primary-foreground">
				<CardHeader className="flex flex-col justify-center items-center bg-primary text-secondary p-6 md:p-12 lg:p-20 rounded-lg mb-5 shadow-2xl">
					<CardTitle className="text-2xl md:text-4xl lg:text-6xl mb-2 md:mb-4 font-mono text-center">
						{m.create_event_title().toLocaleUpperCase()}
					</CardTitle>
					...
					<Form {...form}>
						...
						>
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className="relative left-3">
											{m.form_title_label()}
										</FormLabel>
										<FormControl>
											<Input
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
								...
								>
									<AddressAutofill
										...
										theme={{
											variables: { borderRadius: "1.3rem", padding: "0.7rem" },
										}}
									>
										<FormField
											control={form.control}
							...
							<div className="flex justify-center">
								<Button type="submit">{m.button_submit_event()}</Button>
							</div>
						</form>
					</Form>
				</CardContent>
