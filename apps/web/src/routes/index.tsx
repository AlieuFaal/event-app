  ...
  return (
    <div className="relative">
      <div>
        ...
        <div
          id="section2"
          className="flex flex-col w-full text-center text-white border-t-1 border-b-1"
        >
          <div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="m-4 md:m-8 lg:m-10 w-full md:w-1/4">
              <img
                ...
                alt=""
                className="rounded-2xl w-full h-auto max-h-60 md:max-h-none md:h-47 shadow-2xl object-cover"
              />
            </div>
          </div>
          <div className="flex flex-col md:flex-row-reverse justify-between items-center">
            ...
            <div className="m-4 md:m-8 lg:m-10 w-full md:w-1/4">
              <img
                ...
                alt=""
                className="rounded-2xl w-full h-auto max-h-60 md:max-h-none md:h-54 shadow-2xl object-cover"
              />
            </div>
          </div>
        </div>
